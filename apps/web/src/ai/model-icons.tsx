...
export const ClaudeAI = (props: IconProps) => (
	<svg
		{...props}
		aria-hidden="true"
...
export const Gemini = (props: IconProps) => (
	<svg {...props} aria-hidden="true" fill="none" viewBox="0 0 296 298">
		<mask
			id="gemini__a"
			width="296"
			height="298"
...
export type ModelProvider = keyof typeof MODEL_PROVIDER_ICONS;

export const getModelProviderFromId = (modelId: string): string => {
...
export const ModelProviderIcon = ({
	...
	const Icon =
		MODEL_PROVIDER_ICONS[provider as keyof typeof MODEL_PROVIDER_ICONS];
