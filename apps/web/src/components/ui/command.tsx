...
export function CommandDialogViewport({
  ...
  return (
    <CommandDialogPrimitive.Viewport
      className={cn(
        "fixed inset-0 z-50 flex flex-col items-start px-4 py-[max(--spacing(4),4vh)] sm:items-center sm:py-[10vh]",
        className,
      )}
