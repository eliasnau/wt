	...
	return (
		<section className="relative -mt-14 w-full overflow-hidden pt-28 md:-mt-12 md:pt-24">
			...
			<div className="relative z-10 flex max-w-2xl flex-col gap-5">
				...
				>
					...
					<span className="text-xs">
						Die moderne Plattform für Kampfsportschulen
					</span>
				...
				>
					Die beste Art, deine Kampfsportschule zu verwalten
				</h1>
				...
				>
					Eine moderne Mitgliederverwaltung speziell
			...
			<div className="relative">
				...
				<div
					className={cn(
						"mask-b-from-60% relative mt-8 -mr-56 overflow-hidden sm:mt-12 sm:mr-0 md:mt-20",
						"fade-in slide-in-from-bottom-5 animate-in fill-mode-backwards delay-100 duration-1000 ease-out",
					)}
				>
					<div className="relative inset-shadow-2xs inset-shadow-foreground/10 overflow-hidden rounded-lg border bg-background p-2 shadow-xl ring-1 ring-card dark:inset-shadow-foreground/20 dark:inset-shadow-xs">
						<img
							alt="app screen"
						...
						<img
							...
							height="1080"
							src="https://ik.imagekit.io/codity/wt/landing/hero-dark.webp"
							width="1920"
						/>
					</div>
				</div>
