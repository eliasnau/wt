...
export const Persona: FC<PersonaProps> = memo(
	({
		...
		const inputsRef = useRef({ asleepInput, listeningInput, speakingInput, thinkingInput });

		useEffect(() => {
			inputsRef.current = { asleepInput, listeningInput, speakingInput, thinkingInput };
			const inputs = inputsRef.current;
			if (inputs.listeningInput) {
				inputs.listeningInput.value = state === "listening";
			}
			if (inputs.thinkingInput) {
				inputs.thinkingInput.value = state === "thinking";
			}
			if (inputs.speakingInput) {
				inputs.speakingInput.value = state === "speaking";
			}
			if (inputs.asleepInput) {
				inputs.asleepInput.value = state === "asleep";
			}
