		...
		<Html lang="en" dir="ltr">
			...
			<Body style={main}>
				<Container style={content}>
					...
					<Heading style={title}>Bestätige deine E-Mail-Adresse</Heading>

					<Text style={text}>
						Hallo {userName}, <br />
						<br />
						bitte bestätige deine E-Mail-Adresse, um dein Konto auf matdesk zu
						aktivieren.
					</Text>
					...
					<Text style={linkText}>
						<Link href={verificationLink} style={inlineLink}>
							{verificationLink}
						</Link>
					</Text>
